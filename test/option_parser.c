...
TEST test_string_to_sepcolor_invalid(void)
{
        ...
        ASSERT_EQm("Sep color shouldn't change from invalid inputs", 123, val.type);
        ASSERT_STR_EQm("Sep color shouldn't change from invalid inputs", "test123", val.sep_color);
        PASS();
}
